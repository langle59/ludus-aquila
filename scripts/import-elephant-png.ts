/**
 * Import elephant PNG into public/beasts/elephant.png (magenta keyed, cropped).
 * Usage: npm run import:elephant -- path/to/elephant.png [--flip]
 */
...
const outPath = join(root, "public", "beasts", "elephant.png");
...
async function main(): Promise<void> {
  ...
  if (!srcPath) {
    console.error("Elephant PNG not found. Pass path: npm run import:elephant -- path/to/elephant.png");
    process.exit(1);
  }
