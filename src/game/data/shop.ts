...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  { id: "tunic-fox", kind: "tunic", name: "Fox-orange tunic", description: "Stolen colours. Wear them proudly.", cost: 45 },
  ...
  { id: "plume-fox", kind: "plume", name: "Fox crest", description: "Pointed ears on the galea.", cost: 32 },
  ...
  { id: "cape-fox", kind: "cape", name: "Fox cape", description: "Orange drape. A trophy, not a warning.", cost: 48 },
  ...
  { id: "title-foxbane", kind: "title", name: "Foxbane", description: "Earned in the Fox arena.", cost: 60, requiresOpponent: "fox_1" },
  { id: "title-arena", kind: "title", name: "of the Arena", description: "For those the crowd remembers.", cost: 80, requiresOpponent: "cassian" },
